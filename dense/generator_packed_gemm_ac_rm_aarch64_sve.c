...
#include "generator_packed_gemm_ac_rm_aarch64_sve.h"
...
LIBXSMM_API_INTERN
void libxsmm_generator_packed_gemm_ac_rm_aarch64_sve(   libxsmm_generated_code*         io_generated_code,
  ...
  if ( l_n1_block == i_xgemm_desc->n ) {
    /* no N loop at all */
    libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_sve( io_generated_code, &l_loop_label_tracker, &l_gp_reg_mapping, &l_micro_kernel_config, i_xgemm_desc,
...
LIBXSMM_API_INTERN void libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_sve( libxsmm_generated_code*            io_generated_code,
  ...
  if ( l_sve_packed_width == i_packed_width ) {
    ...
    libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_sve_packed( io_generated_code, io_loop_label_tracker, i_gp_reg_mapping, i_micro_kernel_config, i_xgemm_desc,
                                                                  i_packed_width, l_sve_packed_width, i_n_blocking, LIBXSMM_AARCH64_SVE_REG_P0 );
  ...
  /* we have less than SVE width and apply masking with p1 */
    ...
    libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_sve_packed( io_generated_code, io_loop_label_tracker, i_gp_reg_mapping, i_micro_kernel_config, i_xgemm_desc,
                                                                  i_packed_width, l_sve_packed_width, i_n_blocking, LIBXSMM_AARCH64_SVE_REG_P1 );
...
LIBXSMM_API_INTERN void libxsmm_generator_packed_gemm_ac_rm_aarch64_kloop_sve_packed( libxsmm_generated_code*            io_generated_code,
                                                                                      libxsmm_loop_label_tracker*        io_loop_label_tracker,
                                                                                      const libxsmm_gp_reg_mapping*      i_gp_reg_mapping,
                                                                                      const libxsmm_micro_kernel_config* i_micro_kernel_config,
                                                                                      const libxsmm_gemm_descriptor*     i_xgemm_desc,
  ...
  if ( l_use_masking ) {
    ...
    /* load A without masking predicate */
    libxsmm_aarch64_instruction_sve_move( io_generated_code, LIBXSMM_AARCH64_INSTR_SVE_LDR_Z_I_OFF, 
                                          i_gp_reg_mapping->gp_reg_a, LIBXSMM_AARCH64_GP_REG_UNDEF,
                                          0, i_n_blocking, LIBXSMM_AARCH64_SVE_REG_UNDEF );
