...
void libxsmm_generator_packed_spgemm_csc_bsparse( libxsmm_generated_code*         io_generated_code,
  ...
  if ( (io_generated_code->arch >= LIBXSMM_X86_AVX) &&
    ...
    libxsmm_generator_packed_spgemm_csc_bsparse_avx_avx2_avx512( io_generated_code,
                                                                 i_xgemm_desc,
                                                                 i_row_idx,
                                                                 i_column_idx,
                                                                 i_values,
    ...
    libxsmm_generator_packed_spgemm_csc_bsparse_aarch64( io_generated_code,
                                                         i_xgemm_desc,
                                                         i_row_idx,
                                                         i_column_idx,
                                                         i_values,
    ...
    libxsmm_generator_packed_spgemm_csc_bsparse_aarch64_sve( io_generated_code, 
                                                              i_xgemm_desc, 
                                                              i_row_idx, 
                                                              i_column_idx, 
                                                              i_values, 
    ...
    fprintf( stderr, "PACKED CSC is only available for AVX/AVX2/AVX512 or AARCH64 at this point\n" );
    exit(-1);
  }
}
